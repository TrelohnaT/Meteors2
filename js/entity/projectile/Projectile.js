...
export default class Projectile {
    constructor(id, centerPoint, angle, size, vectorX, vectorY) {
    ...
    setUp() {
        ...
        for (let j = 0; j < 2; j++) {
            ...
            let point = Calculations.pointB_angleB_lengthC(pointId, this.centerPoint, ((this.angle) + (chunkAngle * j)) * 1, this.size / 2);
